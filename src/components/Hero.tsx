...
export default function Hero() {
  return (
    ...
    >
      {/* ── Hero: subtle local depth boost, no hue cycling ── */}
      <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
        {/* Soft indigo wash — top right */}
        ...
        <div className="flex flex-col gap-7 items-center lg:items-start text-center lg:text-left">
          ...
          <div className="w-full">
            <h1
              ...
              style={{ fontFamily: "var(--font-heading, 'Plus Jakarta Sans', Inter, sans-serif)", color: "#ffffff", wordBreak: "break-word", overflowWrap: "break-word" }}
            >
              La{" "}
              <span className="inline-block text-gradient-animated">IA</span>
              {" "}que atiende y{" "}
              <span className="inline-block text-gradient-animated">vende por ti</span>
            </h1>
          </div>
      ...
      {/* Marquee integrado al fondo del Hero */}
